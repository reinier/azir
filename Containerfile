...
# kitty is the terminal. kanshi + wdisplays are the niri-session display layer (see the
# Tashikk backlog 0004). brightnessctl/playerctl are kept for parity with Steen's toolset.
#
